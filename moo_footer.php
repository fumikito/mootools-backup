<div id="footy" class="clear span-24">
	<p class="quiet">
		このドキュメントは<a href="http://mootools.net">MooTools</a>のドキュメントを元に<a href="<?php bloginfo('url'); ?>">高橋文樹</a>が翻訳（ちょっと改変）しました。<br />
...
<?php endif; ?>
<!-- Scripts -->
<script src="<?php echo mootools_url() ?>/mootools.js" type="text/javascript"></script>
<script src="<?php echo mootools_url(); ?>/moo_searchbox.js" type="text/javascript"></script>
</body>
</html>